    ...
    <div class="login-card">
      ...
      <el-form ref="formRef" :model="form" :rules="rules" label-width="0" size="large">
        ...
        <el-form-item prop="password">
          <el-input v-model="form.password" type="password" placeholder="密码" prefix-icon="Lock" @keyup.enter="handleLogin" show-password />
        </el-form-item>
        <el-form-item>
...
.login-title { text-align: center; margin-bottom: 30px; color: #303133; font-size: 20px; }
</style>
